...
INSTALL_JS_GLOBAL="/home/justin/code/wp-json-discovery/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/justin/code/wp-json-discovery/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
