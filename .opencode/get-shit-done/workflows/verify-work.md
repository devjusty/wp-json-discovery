...
<template>
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/justin/code/wp-json-discovery/.opencode/get-shit-done/workflows/transition.md`.
...
- Follow @/home/justin/code/wp-json-discovery/.opencode/get-shit-done/workflows/diagnose-issues.md
