...
```
Agent(
  prompt="Read /home/justin/code/wp-json-discovery/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/justin/code/wp-json-discovery/.opencode/get-shit-done/templates/VALIDATION.md`
