...
<required_reading>
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/user-story-template.md
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/spidr-splitting.md
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
