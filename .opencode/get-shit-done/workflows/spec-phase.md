...
```bash
INIT=$(node "/home/justin/code/wp-json-discovery/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/justin/code/wp-json-discovery/.opencode/get-shit-done/templates/spec.md.
