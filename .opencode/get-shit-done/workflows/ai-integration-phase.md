...
<required_reading>
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/ai-frameworks.md
@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/justin/code/wp-json-discovery/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/justin/code/wp-json-discovery/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/justin/code/wp-json-discovery/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/justin/code/wp-json-discovery/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/justin/code/wp-json-discovery/.opencode/agents/gsd-eval-planner.md for instructions.
