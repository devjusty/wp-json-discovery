...
- **Global scope**: `/home/justin/code/wp-json-discovery/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/justin/code/wp-json-discovery/.opencode/notes/`)
...
2. Glob `/home/justin/code/wp-json-discovery/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/justin/code/wp-json-discovery/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/justin/code/wp-json-discovery/.opencode/notes/` — works in any directory
