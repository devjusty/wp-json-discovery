...
```bash
INIT=$(node "/home/justin/code/wp-json-discovery/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/justin/code/wp-json-discovery/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
