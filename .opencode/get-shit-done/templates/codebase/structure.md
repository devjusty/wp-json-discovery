...
- Usage: Reference from command with `@/home/justin/code/wp-json-discovery/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/justin/code/wp-json-discovery/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/justin/code/wp-json-discovery/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
